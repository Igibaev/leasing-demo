...
_FREEZE_SCRIPT="$HOME/.opencode/skills/gstack/freeze/bin/check-freeze.sh"
...
```bash
~/.config/opencode/skills/gstack/bin/gstack-learnings-log '{"skill":"investigate","type":"investigation","key":"ROOT_CAUSE_KEY","insight":"ROOT_CAUSE_SUMMARY","confidence":9,"source":"observed","files":["affected/file1.ts","affected/file2.ts"]}'
```
