...
```bash
$GSTACK_BIN/gstack-skill-end --skill "open-gstack-browser" --outcome OUTCOME \
...
_EXT_PATH=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/.opencode/skills/gstack/extension/manifest.json" ] && _EXT_PATH="$_ROOT/.opencode/skills/gstack/extension"
[ -z "$_EXT_PATH" ] && [ -f "$HOME/.opencode/skills/gstack/extension/manifest.json" ] && _EXT_PATH="$HOME/.opencode/skills/gstack/extension"
