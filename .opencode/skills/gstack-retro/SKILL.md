...
```bash
_RM="$HOME/.opencode/skills/gstack/bin/gstack-retro-metrics"
[ -x "$_RM" ] || _RM=".opencode/skills/gstack/bin/gstack-retro-metrics"
...
```bash
DISCOVER_BIN=""
[ -x ~/.config/opencode/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.config/opencode/skills/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .opencode/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.opencode/skills/gstack/bin/gstack-global-discover
